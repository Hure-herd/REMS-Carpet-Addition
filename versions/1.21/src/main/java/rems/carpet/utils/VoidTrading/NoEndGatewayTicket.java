...
public class NoEndGatewayTicket {
    private static final Set<BlockPos> Pos = ConcurrentHashMap.newKeySet();

    public static void add(BlockPos pos) {Pos.add(pos.toImmutable());}

    public static void remove(BlockPos pos) {Pos.remove(pos.toImmutable());}

    public static boolean isMarked(BlockPos pos) {
        return Pos.contains(pos);
    }
    ...
    public static Set<BlockPos> getAll() {return Pos;}
}
